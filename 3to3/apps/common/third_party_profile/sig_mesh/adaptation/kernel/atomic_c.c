...
#pragma bss_seg(".ble_mesh_kernel_bss")
#pragma data_seg(".ble_mesh_kernel_data")
#pragma const_seg(".ble_mesh_kernel_const")
#pragma code_seg(".ble_mesh_kernel_code")
#endif
 ...
 */
int atomic_cas(atomic_tt *target, atomic_val_t old_value,
 ...
 */
atomic_val_t atomic_add(atomic_tt *target, atomic_val_t value)
{
    unsigned int key;
    atomic_val_t ret;
 ...
 * @return The previous value from <target>
 */
atomic_val_t atomic_sub(atomic_tt *target, atomic_val_t value)
{
    unsigned int key;
    atomic_val_t ret;
 ...
 */
atomic_val_t atomic_inc(atomic_tt *target)
{
    unsigned int key;
    atomic_val_t ret;
 ...
 */
atomic_val_t atomic_dec(atomic_tt *target)
{
    unsigned int key;
    atomic_val_t ret;
 ...
 */
atomic_val_t atomic_get(const atomic_tt *target)
{
    return *target;
}
 ...
 * @return The previous value from <target>
 */
atomic_val_t atomic_sett(atomic_tt *target, atomic_val_t value)
{
    unsigned int key;
    atomic_val_t ret;
 ...
 * @return The previous value from <target>
 */
atomic_val_t atomic_clear(atomic_tt *target)
{
    unsigned int key;
    atomic_val_t ret;
 ...
 * @return The previous value from <target>
 */
atomic_val_t atomic_or(atomic_tt *target, atomic_val_t value)
{
    unsigned int key;
    atomic_val_t ret;
 ...
 * @return The previous value from <target>
 */
atomic_val_t atomic_xor(atomic_tt *target, atomic_val_t value)
{
    unsigned int key;
    atomic_val_t ret;
 ...
 * @return The previous value from <target>
 */
atomic_val_t atomic_and(atomic_tt *target, atomic_val_t value)
{
    unsigned int key;
    atomic_val_t ret;
 ...
 * @return The previous value from <target>
 */
atomic_val_t atomic_nand(atomic_tt *target, atomic_val_t value)
{
    unsigned int key;
    atomic_val_t ret;
