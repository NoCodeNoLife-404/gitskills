...
#define GET_VDC13_VOL_SEL()       (P33_CON_GET(P3_ANA_CON6) & 0x7)
 ...
 *-------------------P3_PR_PWR
 */
#define MCLR_EN(a)	            P33_CON_SET(P3_PR_PWR, 3, 1, a)

#define P3_SOFT_RESET(a)		P33_CON_SET(P3_PR_PWR, 4, 1, a)
